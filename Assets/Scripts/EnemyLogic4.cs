...
public class EnemyLogic4 : MonoBehaviour
{
    public Vector3 catapultLaunch = new Vector3(30.0f, 40.0f, 30.0f);
    public Vector3 start = new Vector3(0, 27, 0);
    ...
    void FixedUpdate()
    {
        ...
        if (time < 0)
        {
            ...
            time = Random.Range(0f,1000f)+200f;
        }
